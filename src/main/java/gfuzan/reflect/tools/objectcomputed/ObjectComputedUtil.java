package gfuzan.reflect.tools.objectcomputed;
...
public class ObjectComputedUtil {
    ...
    private static <T> T objectOperation(T o1, T o2, char op, boolean nullIsZero, Boolean defValueIsOne,
            Class<?>... opAttType) {
        if (o1 == null && o2 == null) {
            return null;
        } else if (o1 == null) {
     ...
     * @return 类型判断执行相应操作方法
     */
    private static Object operation(Object o1, Object o2, char op, boolean nullIsZero, Boolean defValueIsOne,
            Class<?>... opAttType) throws Exception {
        Object res = null;
